...
/**
 * This class will show the questions that user need to answer for sorting hat quiz.
 * Based on the user choose, this class will give point to each option
 * to help declaring the user's Hogwarts house.
 *
